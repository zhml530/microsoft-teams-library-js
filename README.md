...
You can access [these files on unpkg](https://unpkg.com/@microsoft/teams-js@1.5.0-beta.0/dist/MicrosoftTeams.min.js), download them, or point your package manager to them.
...
<script src="https://unpkg.com/@microsoft/teams-js@1.5.0-beta.0/dist/MicrosoftTeams.min.js" integrity="sha384-C0crsyvcD5WbesgvvNCpuEvcnon4/jhDrMFzULVHIcjOO/k46B23rRH0FpDorh/k" crossorigin="anonymous"></script>

<!-- Microsoft Teams JavaScript API (via npm) -->
<script src="node_modules/@microsoft/teams-js@1.5.0-beta.0/dist/MicrosoftTeams.min.js"></script>
