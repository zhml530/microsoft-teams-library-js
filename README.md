...
You can access [these files on unpkg](https://unpkg.com/@microsoft/teams-js@1.3.0-alpha.2/dist/MicrosoftTeams.min.js), download them, or point your package manager to them.
...
<script src="node_modules/@microsoft/teams-js@1.3.0-alpha.2/dist/MicrosoftTeams.min.js"></script>
