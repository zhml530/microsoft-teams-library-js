...
You can access [these files on unpkg](https://statics.teams.cdn.office.net/sdk/v1.7.0-beta.3/js/MicrosoftTeams.min.js), download them, or point your package manager to them.
...
<script src="https://statics.teams.cdn.office.net/sdk/v1.7.0-beta.3/js/MicrosoftTeams.min.js" integrity="sha384-mhp2E+BLMiZLe7rDIzj19WjgXJeI32NkPvrvvZBrMi5IvWup/1NUfS5xuYN5S3VT" crossorigin="anonymous"></script>

<!-- Microsoft Teams JavaScript API (via npm) -->
<script src="node_modules/@microsoft/teams-js@1.7.0-beta.3/dist/MicrosoftTeams.min.js"></script>
