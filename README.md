...
You can access [these files on unpkg](https://unpkg.com/@microsoft/teams-js@1.6.0-beta.11/dist/MicrosoftTeams.min.js), download them, or point your package manager to them.
...
<script src="https://unpkg.com/@microsoft/teams-js@1.6.0-beta.11/dist/MicrosoftTeams.min.js" crossorigin="anonymous"></script>

<!-- Microsoft Teams JavaScript API (via npm) -->
<script src="node_modules/@microsoft/teams-js@1.6.0-beta.11/dist/MicrosoftTeams.min.js"></script>
