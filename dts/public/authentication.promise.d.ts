 ...
 */
export declare namespace authenticationAsync {
    /**
     * Initiates an authentication request, which opens a new window with the specified settings.
     */
    function authenticate(authenticateParameters: AuthenticateParameters): Promise<any>;
    /**
     * @private
     * Hide from docs.
     * ------
     ...
     */
    function getAuthToken(resources: string[]): Promise<string>;
    /**
     * @private
     * Hide from docs.
     * ------
