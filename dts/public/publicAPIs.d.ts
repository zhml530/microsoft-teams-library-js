 ...
 */
export declare function initialize(hostWindow?: any): AppInitializationEvent;
/**
 * Initializes the library. This must be called before any other SDK calls
 * but after the frame is loaded successfully.
 */
...
export declare class AppInitializationEvent implements IAppInitializationEvent {
    notifySuccess(): void;
